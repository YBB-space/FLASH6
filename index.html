    ...
    function onIncomingSample(data, srcTag){
      ...
      logData.push({time:timeIso,t:thrustVal,p,lt,elapsed:elapsedMs,hz:hxHz,ct:ctUs,s:sw?1:0,ic:ic?1:0,r:rly?1:0,gs,st,td});
    ...
    document.addEventListener("DOMContentLoaded", async ()=>{
      ...
      const setActiveView = (title)=>{
        ...
        const isDashboard = !isHome && !isTerminal && !isHardware && !isCountdown && !isControl;
        if(el.pageKicker){
